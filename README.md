...
1. The policy documents can be found [here](https://github.com/hellotorax123/Semantic-Spotter-Project/tree/main/Policy%2BDocuments)
...
- Clone the github repository
  ```shell
  $ git clone https://github.com/hellotorax123/Semantic-Spotter-Project.git
  ```
- Open
  the [notebook](https://github.com/hellotorax123/Semantic-Spotter-Project/blob/main/semantic_spotter_RakeshKumarPadhiary.ipynb)
